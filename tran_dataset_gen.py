...
for tid in range(N_TRANSACTIONS):
    ...
    # --- Operational anomaly: very high compared to customer profile ---
    if amount > cust.base_amount * 5:
        op_anomaly_flag = 1
    ...
    # --- AML flagging ---
    if round(amount, -3) == amount:  # round figures
        aml_flag = 1
    if amount > 9000 and amount < 10000:  # structuring below threshold
        aml_flag = 1
    ...
    transactions.append({
        ...
        "op_anomaly_flag": op_anomaly_flag,
